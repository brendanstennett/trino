...
{
    private static final Logger log = Logger.get(RedshiftPageSinkProvider.class);
            ...
            ConnectorPageSinkId pageSinkId)
    {
        if (isBatchedInsertsCopyEnabled(session)) {
            ...
            return new RedshiftBatchedInsertsCopyPageSink(
                    ...
                    RedshiftClient.outputPrefix(session, redshiftConfig.getBatchedInsertsCopyLocation()),
