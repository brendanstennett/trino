...
import static io.trino.plugin.redshift.copy.TestingRedshiftServer.JDBC_PASSWORD;
import static io.trino.plugin.redshift.copy.TestingRedshiftServer.JDBC_URL;
import static io.trino.plugin.redshift.copy.TestingRedshiftServer.JDBC_USER;
import static io.trino.plugin.redshift.copy.TestingRedshiftServer.TEST_DATABASE;
...
import static io.trino.plugin.redshift.copy.TestingRedshiftServer.executeInRedshiftWithRetry;
...
public final class RedshiftQueryRunner
{
    ...
    private static final String CONNECTOR_NAME = "redshift_copy";
            ...
            extends DistributedQueryRunner.Builder<Builder>
    {
                ...
                throws Exception
        {
            ...
            try {
                ...
                runner.installPlugin(new RedshiftCopyPlugin());
